...
export default function EvaluatorFooter() {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li>
                  <Link href="/dashboard/evaluator/help" className="text-sm text-gray-500 hover:text-gray-700">
                    Help Center
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard/evaluator/guidelines" className="text-sm text-gray-500 hover:text-gray-700">
                    Evaluation Guidelines
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard/evaluator/faq" className="text-sm text-gray-500 hover:text-gray-700">
                    FAQ
                  </Link>
                </li>
              </ul>
          ...
          <div className="mt-8 border-t border-gray-200 pt-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0">
              <p className="text-xs text-gray-500">
                Platform designed for academic project review and evaluation.
              </p>
            </div>
          </div>
        </div>
